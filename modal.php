...
<body>
    ...
    <div class="container">
        <div class="row" style="margin-top: 30px;margin-Bottom:30px">
            ...
            ?>
                <div class="column">
                    <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($rows['image']); ?>" style="width:100%" onclick="openModal();currentSlide(<?php echo $rows['id']; ?>-1)" class="hover-shadow cursor">
                </div>
